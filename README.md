...
75 real-world IAM policies across 23 AWS services, sourced from:
- 45 GitHub CloudFormation templates (`aws-samples`, `awslabs`)
- 30 AWS Managed Policies (held out from retrieval corpus)

Queries generated by GPT-4o as task-level natural language descriptions (no service/action names leaked).
